...
static ImGui_ImplPugl_Data *ImGui_ImplPugl_GetBackendData()
{
    return ImGui::GetCurrentContext()
               ? static_cast<ImGui_ImplPugl_Data *>(ImGui::GetIO().BackendPlatformUserData)
               : nullptr;
}
...
void ImGui_ImplPugl_NewFrame()
{
    ...
    switch (cursor) {
    case ImGuiMouseCursor_TextInput: puglCursor = PUGL_CURSOR_CARET; break;
    case ImGuiMouseCursor_ResizeAll: puglCursor = PUGL_CURSOR_ALL_SCROLL; break;
    case ImGuiMouseCursor_ResizeNS: puglCursor = PUGL_CURSOR_UP_DOWN; break;
    case ImGuiMouseCursor_ResizeEW: puglCursor = PUGL_CURSOR_LEFT_RIGHT; break;
    case ImGuiMouseCursor_ResizeNESW: puglCursor = PUGL_CURSOR_UP_RIGHT_DOWN_LEFT; break;
    case ImGuiMouseCursor_ResizeNWSE: puglCursor = PUGL_CURSOR_UP_LEFT_DOWN_RIGHT; break;
    case ImGuiMouseCursor_Hand: puglCursor = PUGL_CURSOR_HAND; break;
    case ImGuiMouseCursor_NotAllowed: puglCursor = PUGL_CURSOR_NO; break;
    default: puglCursor = PUGL_CURSOR_ARROW; break;
    }
...
void ImGui_ImplPugl_ProcessEvent(const PuglEvent *event)
{
    ...
    case PUGL_SCROLL:
        ...
        io.AddMouseWheelEvent(static_cast<float>(event->scroll.dx), static_cast<float>(event->scroll.dy));
        break;
